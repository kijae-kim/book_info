...
openai.api_key = 'sk-proj-ZUqZk44RvTM8fGVE2pllT3BlbkFJQAcxr9Ey6AjokIw8zdAQ'
...
def translate_text_chatgpt(text, src_lang, trg_lang):
    ...
    system_instruction = f"assistant는 번역앱으로서 동작한다. {src_lang}을 {trg_lang}로 적절하게 번역하고 전역된 텍스트만 출력한다."
    fewshot_messages = build_fewshot(src_lang = src_lang, trg_lang=trg_lang)

    messages = [{"role":"system", "content": system_instruction}, *fewshot_messages,
